<?php echo $header; ?>
		...
		<div class="<?php if ($column_left) { ?>col-sm-9 right<?php } ?> <?php if ($column_right) { ?>col-sm-9<?php } ?> <?php if (!$column_left & !$column_left) { ?>col-sm-12  <?php } ?> <?php if ($column_left & $column_right) { ?>col-sm-6<?php } ?>" id="content"><?php echo $content_top; ?>
	...
	<div class="col-sm-8"> <?php } else { ?> <div class="col-sm-12"> <?php } ?>
	  ...
	  <div class="cart">
		<div class="prod-row">
			<div class="cart-top">
				...
				<div class="extra-button">
					<div class="wishlist">
						<a class="tooltip-1" onclick="addToWishList('<?php echo $product_id; ?>');" title="<?php echo $button_wishlist; ?>"><i class="fa fa-star"></i><span><?php echo $button_wishlist; ?></span></a>
					</div>
					<div class="compare">
						<a class="tooltip-1" onclick="addToCompare('<?php echo $product_id; ?>');" title="<?php echo $button_compare; ?>"><i class="fa fa-bar-chart-o"></i><span><?php echo $button_compare; ?></span></a>
					</div>
				</div>
				<div class="clear"></div>
				<?php if ($minimum > 1) { ?>
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme442/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
	...
	<div class="box-product"> 
		<ul class="related-slider">
			...
			<?php if ($product['price']) { ?>
				...
				<?php } ?>
			<div class="name maxheight-rel"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
				<div class="cart">
					<a title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button tooltip-2"><span>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme442/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme442/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
