...
<div class="buttons">
  <table>
	<tr>
	  ...
	  <td class="text-right"><a href="<?php echo $confirm; ?>" class="button"><?php echo $button_confirm; ?></a></td>
	</tr>
  </table>
</div>
...
<div class="buttons">
  <table>
	<tr>
	  <td class="text-left"><a href="<?php echo $back; ?>" class="button"><?php echo $button_back; ?></a></td>
